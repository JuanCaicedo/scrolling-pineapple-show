...
const runSrc = (frame: number) => `/pineapple-run-three-quarter-${frame}.png`;

const firstFrame = runningFrames[0];
const lastFrame = runningFrames[runningFrames.length - 1];

const PineappleRunThreeQuarter = React.forwardRef(
  function PineappleRunThreeQuarter(
...
export default PineappleRunThreeQuarter;
